...
public:
	...
	static void addEdge(Map * map, City & src, City & dest, int cost);
	//void addEdge(Map * map, City & src, City & dest, int cost);
	static void BFS(Map * map, City s);
	static int BFS(Map * map, City src, City dest);

	static void BFS(Map * map, int src, int dest);
	...
	void displayCityVector(vector<City*> city);
	...
	City returnCityFromId(Map * map, int id);
